...
from mkdata import tx_onehot_encoded_df, tx_labels
...
fea_vec_num = tx_onehot_encoded_df.shape[0]
label_vec_num = 2
...
b = tf.Variable(tf.zeros([fea_vec_num]))
...
with tf.Session() as sess:
    ...
    for epoch in range(training_epochs):
        ...
        for i in range(total_batch):
            ...
            batch_xs = tx_onehot_encoded_df[begin_idx:begin_idx+batch_size,  ]
            batch_ys = tx_labels[begin_idx:begin_idx+ batch_size, ]
